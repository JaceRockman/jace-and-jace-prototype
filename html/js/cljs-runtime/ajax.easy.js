...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__37807 = cljs.core.second(format);
var G__37808 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__37807,G__37808) : ajax.easy.keyword_response_format_element.call(null,G__37807,G__37808));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37810_SHARP_){
return ajax.easy.keyword_response_format_element(p1__37810_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__37814){
var map__37815 = p__37814;
var map__37815__$1 = (((((!((map__37815 == null))))?(((((map__37815.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__37815.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__37815):map__37815);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37815__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37815__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37815__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return (function ajax$easy$transform_handler_$_easy_handler(p__37820){
var vec__37821 = p__37820;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37821,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37821,(1),null);
var fexpr__37824_37863 = (cljs.core.truth_(ok)?h:e);
(fexpr__37824_37863.cljs$core$IFn$_invoke$arity$1 ? fexpr__37824_37863.cljs$core$IFn$_invoke$arity$1(result) : fexpr__37824_37863.call(null,result));
...
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__37825){
var map__37830 = p__37825;
var map__37830__$1 = (((((!((map__37830 == null))))?(((((map__37830.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__37830.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__37830):map__37830);
var opts = map__37830__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37830__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37830__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37830__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37830__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37830__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
