...
var G__37994 = format;
var G__37994__$1 = (((G__37994 instanceof cljs.core.Keyword))?G__37994.fqn:null);
switch (G__37994__$1) {
case "transit":
return ajax.transit.transit_request_format.cljs$core$IFn$_invoke$arity$1(format_params);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__37996 = cljs.core.second(format);
var G__37997 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__37996,G__37997) : ajax.easy.keyword_response_format_element.call(null,G__37996,G__37997));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37999_SHARP_){
return ajax.easy.keyword_response_format_element(p1__37999_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__38002){
var map__38003 = p__38002;
var map__38003__$1 = cljs.core.__destructure_map(map__38003);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38003__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38003__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38003__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return (function ajax$easy$transform_handler_$_easy_handler(p__38006){
var vec__38007 = p__38006;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38007,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38007,(1),null);
var fexpr__38011_38024 = (cljs.core.truth_(ok)?h:e);
(fexpr__38011_38024.cljs$core$IFn$_invoke$arity$1 ? fexpr__38011_38024.cljs$core$IFn$_invoke$arity$1(result) : fexpr__38011_38024.call(null,result));
...
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__38012){
var map__38013 = p__38012;
var map__38013__$1 = cljs.core.__destructure_map(map__38013);
var opts = map__38013__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38013__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38013__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38013__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38013__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38013__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
