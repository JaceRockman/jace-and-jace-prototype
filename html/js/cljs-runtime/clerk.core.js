...
var temp__5751__auto___38762 = event.state;
if(cljs.core.truth_(temp__5751__auto___38762)){
var state_38763 = temp__5751__auto___38762;
var temp__5753__auto___38764 = (state_38763["scroll-top"]);
if(cljs.core.truth_(temp__5753__auto___38764)){
var scroll_top_38766 = temp__5753__auto___38764;
goog.events.listenOnce(window,goog.events.EventType.SCROLL,(function (){
scrollTo((0),scroll_top_38766);
...
var scroll_top_38768 = clerk.core.get_scroll_top();
var state_38769 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"scroll-top","scroll-top",-46723100),scroll_top_38768], null);
history.replaceState(cljs.core.clj__GT_js(state_38769),document.title);
...
var len__4818__auto___38770 = arguments.length;
var i__4819__auto___38772 = (0);
while(true){
if((i__4819__auto___38772 < len__4818__auto___38770)){
args__4824__auto__.push((arguments[i__4819__auto___38772]));

var G__38773 = (i__4819__auto___38772 + (1));
i__4819__auto___38772 = G__38773;
continue;
} else {
}
break;
...
return clerk.core.navigate_page_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__4825__auto__);
});

(clerk.core.navigate_page_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__38739){
var vec__38741 = p__38739;
var top_element_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38741,(0),null);
...
if(cljs.core.truth_((function (){var and__4210__auto__ = same_page_QMARK_;
...
/** @this {Function} */
(clerk.core.navigate_page_BANG_.cljs$lang$applyTo = (function (seq38731){
