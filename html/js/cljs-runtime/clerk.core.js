...
var G__38444 = window;
var G__38445 = goog.events.EventType.POPSTATE;
var G__38446 = (function (event){
var temp__5733__auto___38481 = event.state;
if(cljs.core.truth_(temp__5733__auto___38481)){
var state_38482 = temp__5733__auto___38481;
var temp__5735__auto___38483 = (state_38482["scroll-top"]);
if(cljs.core.truth_(temp__5735__auto___38483)){
var scroll_top_38484 = temp__5735__auto___38483;
var G__38447_38485 = window;
var G__38448_38486 = goog.events.EventType.SCROLL;
var G__38449_38487 = (function (){
scrollTo((0),scroll_top_38484);

return null;
});
goog.events.listenOnce(G__38447_38485,G__38448_38486,G__38449_38487);
} else {
}
} else {
}
...
return goog.events.listen(G__38444,G__38445,G__38446);
}
});
/**
...
var G__38453 = window;
var G__38454 = goog.events.EventType.SCROLL;
var G__38455 = clerk.core.debounce.cljs$core$IFn$_invoke$arity$2((function (event){
var scroll_top_38494 = clerk.core.get_scroll_top();
var state_38495 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"scroll-top","scroll-top",-46723100),scroll_top_38494], null);
history.replaceState(cljs.core.clj__GT_js(state_38495),document.title);

return null;
}),(200));
return goog.events.listen(G__38453,G__38454,G__38455);
});
/**
...
var i__4790__auto___38518 = (0);
while(true){
if((i__4790__auto___38518 < len__4789__auto___38513)){
args__4795__auto__.push((arguments[i__4790__auto___38518]));

var G__38519 = (i__4790__auto___38518 + (1));
i__4790__auto___38518 = G__38519;
continue;
} else {
}
break;
...
(clerk.core.navigate_page_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__38461){
var vec__38462 = p__38461;
var top_element_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38462,(0),null);
...
/** @this {Function} */
(clerk.core.navigate_page_BANG_.cljs$lang$applyTo = (function (seq38459){
var G__38460 = cljs.core.first(seq38459);
var seq38459__$1 = cljs.core.next(seq38459);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38460,seq38459__$1);
}));
