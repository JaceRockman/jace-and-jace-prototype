...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k36794,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k36794,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__36808){
var vec__36809 = p__36808;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36809,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36809,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__36793){
var self__ = this;
var G__36793__$1 = this;
return (new cljs.core.RecordIter((0),G__36793__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__36816 = (function (coll__4436__auto__){
return (-473222333 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__36816(this__4435__auto____$1);
})();
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this36795,other36796){
var self__ = this;
var this36795__$1 = this;
return (((!((other36796 == null)))) && ((this36795__$1.constructor === other36796.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36795__$1.status,other36796.status)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36795__$1.body,other36796.body)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36795__$1.status_text,other36796.status_text)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36795__$1.headers,other36796.headers)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36795__$1.was_aborted,other36796.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36795__$1.__extmap,other36796.__extmap)));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__36793){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__36827 = cljs.core.keyword_identical_QMARK_;
var expr__36828 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__36831 = new cljs.core.Keyword(null,"status","status",-1997798413);
var G__36832 = expr__36828;
return (pred__36827.cljs$core$IFn$_invoke$arity$2 ? pred__36827.cljs$core$IFn$_invoke$arity$2(G__36831,G__36832) : pred__36827.call(null,G__36831,G__36832));
})())){
return (new ajax.protocols.Response(G__36793,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__36833 = new cljs.core.Keyword(null,"body","body",-2049205669);
var G__36834 = expr__36828;
return (pred__36827.cljs$core$IFn$_invoke$arity$2 ? pred__36827.cljs$core$IFn$_invoke$arity$2(G__36833,G__36834) : pred__36827.call(null,G__36833,G__36834));
})())){
return (new ajax.protocols.Response(self__.status,G__36793,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__36835 = new cljs.core.Keyword(null,"status-text","status-text",-1834235478);
var G__36836 = expr__36828;
return (pred__36827.cljs$core$IFn$_invoke$arity$2 ? pred__36827.cljs$core$IFn$_invoke$arity$2(G__36835,G__36836) : pred__36827.call(null,G__36835,G__36836));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,G__36793,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__36837 = new cljs.core.Keyword(null,"headers","headers",-835030129);
var G__36838 = expr__36828;
return (pred__36827.cljs$core$IFn$_invoke$arity$2 ? pred__36827.cljs$core$IFn$_invoke$arity$2(G__36837,G__36838) : pred__36827.call(null,G__36837,G__36838));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__36793,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__36839 = new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828);
var G__36840 = expr__36828;
return (pred__36827.cljs$core$IFn$_invoke$arity$2 ? pred__36827.cljs$core$IFn$_invoke$arity$2(G__36839,G__36840) : pred__36827.call(null,G__36839,G__36840));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__36793,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__36793),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__36793){
var self__ = this;
var this__4438__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__36793,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__36799){
var extmap__4478__auto__ = (function (){var G__36853 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__36799,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__36799)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__36853);
} else {
return G__36853;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__36799),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__36799),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__36799),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__36799),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__36799),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
