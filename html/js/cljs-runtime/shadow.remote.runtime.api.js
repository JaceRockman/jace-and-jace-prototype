...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_29277 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_29277(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_29283 = (function (runtime,key,spec){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_29283(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_29284 = (function (runtime,key){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_29284(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_29289 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_29289(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_29303 = (function (runtime,input,callback){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_29303(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_29309 = (function (runtime,code){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_29309(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__29274,callback){
var map__29275 = p__29274;
var map__29275__$1 = cljs.core.__destructure_map(map__29275);
var input = map__29275__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29275__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29275__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
