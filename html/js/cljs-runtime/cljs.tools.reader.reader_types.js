...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_26575 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_26575(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_26576 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_26576(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26577 = (function (reader,ch){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26577(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26579 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26579(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26580 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26580(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26581 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26581(reader);
}
});
...
var G__26627 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__26628 = s.append(c);
c = G__26627;
s = G__26628;
continue;
}
