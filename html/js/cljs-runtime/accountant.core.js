...
if(cljs.core.truth_((function (){var and__4210__auto__ = node;
...
var navigation_link_QMARK_ = (function (){var and__4210__auto__ = href;
if(cljs.core.truth_(and__4210__auto__)){
var and__4210__auto____$1 = attrs;
...
var any_key = (function (){var or__4212__auto__ = meta_key;
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
var or__4212__auto____$1 = alt_key;
if(cljs.core.truth_(or__4212__auto____$1)){
return or__4212__auto____$1;
} else {
var or__4212__auto____$2 = ctrl_key;
...
if(cljs.core.truth_((function (){var and__4210__auto__ = cljs.core.not(any_key);
if(and__4210__auto__){
var and__4210__auto____$1 = (function (){var fexpr__37267 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["",null,"_self",null], null), null);
return (fexpr__37267.cljs$core$IFn$_invoke$arity$1 ? fexpr__37267.cljs$core$IFn$_invoke$arity$1(link_target) : fexpr__37267.call(null,link_target));
})();
if(cljs.core.truth_(and__4210__auto____$1)){
var and__4210__auto____$2 = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(button,(0));
if(and__4210__auto____$2){
var and__4210__auto____$3 = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(host,current_host);
if(and__4210__auto____$3){
var and__4210__auto____$4 = ((cljs.core.not(port)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(port),cljs.core.str.cljs$core$IFn$_invoke$arity$1(current_port))));
 ...
 */
accountant.core.configure_navigation_BANG_ = (function accountant$core$configure_navigation_BANG_(p__37278){
var map__37279 = p__37278;
var map__37279__$1 = cljs.core.__destructure_map(map__37279);
var nav_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37279__$1,new cljs.core.Keyword(null,"nav-handler","nav-handler",2039495484));
var path_exists_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37279__$1,new cljs.core.Keyword(null,"path-exists?","path-exists?",1473384514));
var reload_same_path_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37279__$1,new cljs.core.Keyword(null,"reload-same-path?","reload-same-path?",1981904231));
...
var params = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37283_SHARP_){
return cljs.core.name(p1__37283_SHARP_);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("&",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37285_SHARP_){
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("=",p1__37285_SHARP_);
}),pairs));
});
/**
...
if(cljs.core.truth_(accountant.core.nav_handler)){
var G__37354 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(query),cljs.core.str.cljs$core$IFn$_invoke$arity$1(hash)].join('');
return (accountant.core.nav_handler.cljs$core$IFn$_invoke$arity$1 ? accountant.core.nav_handler.cljs$core$IFn$_invoke$arity$1(G__37354) : accountant.core.nav_handler.call(null,G__37354));
} else {
