...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__37703){
var map__37704 = p__37703;
...
var request = map__37704__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37704__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__37709 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__37709.cljs$core$IFn$_invoke$arity$1 ? fexpr__37709.cljs$core$IFn$_invoke$arity$1(response) : fexpr__37709.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__37711 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__37711.cljs$core$IFn$_invoke$arity$1 ? fexpr__37711.cljs$core$IFn$_invoke$arity$1(response) : fexpr__37711.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__37712){
...
var request = map__37713__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37713__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
