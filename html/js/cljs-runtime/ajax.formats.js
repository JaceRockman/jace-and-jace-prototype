...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__37920){
var map__37921 = p__37920;
var map__37921__$1 = cljs.core.__destructure_map(map__37921);
var request = map__37921__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37921__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__37932 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__37932.cljs$core$IFn$_invoke$arity$1 ? fexpr__37932.cljs$core$IFn$_invoke$arity$1(response) : fexpr__37932.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__37936 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__37936.cljs$core$IFn$_invoke$arity$1 ? fexpr__37936.cljs$core$IFn$_invoke$arity$1(response) : fexpr__37936.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__37940){
var map__37943 = p__37940;
var map__37943__$1 = cljs.core.__destructure_map(map__37943);
var request = map__37943__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37943__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
